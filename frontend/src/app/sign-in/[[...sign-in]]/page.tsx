...
import { Building, ShieldAlert, ArrowLeft, Sparkles, LogIn, Lock, Mail } from "lucide-react";
            ...
            {!selectedPortal ? (
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-xs font-semibold text-slate-500 hover:text-blue-600 dark:hover:text-blue-450 transition-colors self-start ml-2 sm:ml-4 animate-fade-in"
                >
                    ...
                    >
                      <div className="text-center mb-2">
                        ...
                        <h2 className="text-xl font-bold text-slate-900 dark:text-white">
                          Sign In to {selectedPortal === "admin" ? "Admin Panel" : "ERP Space"}
                        </h2>
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                          No database credentials required. Enter any email to continue.
                        </p>
                      </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input 
                              type="email" 
                              required
                              placeholder="demo@suppliererp.com"
                              value={email}
